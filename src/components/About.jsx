    ...
    <div className="w-full my-32">
      <div className="max-w-[1240px] mx-auto">
        <div className="text-center">
          ...
          <p className="text-3xl py-6 text-gray-500">
          Polske Staltech har vært aktiv i markedet for
            landbrukstjenester siden starten av 1980-tallet. De står for
            holdbarhet, funksjonalitet og estetikk. Deres hovedmål er å
            produsere og selge produkter av høy kvalitet til en fornuftig pris.
          ...
          <p className="text-3xl py-6 text-gray-500">
          Staltech gir 1 års garanti på alle maskiner for å sikre at
            du som kunde er fornøyd med ditt nye produkt. Vi har også
            reservedeler til alle maskiner vi selger. Velkommen til å kontakte
            oss!
          </p>
        </div>
